...
$query = "SELECT * FROM " . $table . " WHERE " . $condition . " = ? AND member_id = ?";
...
$deleteQuery = "DELETE FROM " . $table . " WHERE " . $condition . " = ? AND member_id = ?";
...
$insert = "INSERT INTO " . $table . " (member_id, $condition) VALUES (?, ?)";
//    echo $insert;
//    return;
